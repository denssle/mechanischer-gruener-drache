...
- [ ] Mit dem eigentlichen Spiel interagieren (Machbarkeitsnotiz: `docs/spiel-interaktion-idee.md`) – der **lesende, öffentliche** Teil ist erledigt (`/news`, `/ereignisse`, `/online`, alles per Scraping ohne Login); offen bleibt die **authentifizierte** Interaktion (Charakterdaten etc. via programmatischem Login)
