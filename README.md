...
- Mit dem eigentlichen Spiel interagieren (Machbarkeitsnotiz + Stufen: `docs/spiel-interaktion-idee.md`):
  ...
  - [ ] **Stufe 2 – persönliche Leseabfragen pro User (eingeloggt):** privates Gold/Werte/Status hinter dem Login. Braucht eine Session pro User; bewusst zurückgestellt (keine gespeicherten Passwörter – der md5-Hash von lotgd.de ist login-äquivalent). Falls je: selbst hinterlegtes **Session-Token** (opt-in), nicht das Passwort
