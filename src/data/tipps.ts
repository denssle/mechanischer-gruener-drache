...
export const TIPPS: Tipp[] = [
    ...
    {befehl: 'sport', text: 'Tipp: Mit `/sport eintragen` trägst du Kilometer, Aktivitätsminuten oder beides bei – es gibt bewusst keine Rangliste.'},
    {befehl: 'sport', text: 'Tipp: `/sport gesamt` zeigt, wie viele Kilometer und Aktivitätsminuten der Server zusammen schon gesammelt hat.'},
    ...
    {befehl: 'bash', text: 'Tipp: `/bash zitat` zieht einen gespeicherten Spruch aus der Sammlung – festgehalten wird per Rechtsklick auf eine Nachricht (Apps → „Als Bash-Zitat speichern").'},
